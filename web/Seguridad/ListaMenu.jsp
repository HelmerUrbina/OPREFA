    ...
    $(document).ready(function () {
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            columns: [
                ...
                {text: 'MÓDULO', dataField: 'modulo', filtertype: 'list', width: '20%', align: 'center', cellsAlign: 'left', cellclassname: cellclass},
                ...
                $('#div_VentanaPrincipal').jqxWindow({
                    ...
                    initContent: function () {
                        ...
                        $('#frm_Menu').jqxValidator({
                            rules: [
                                {input: '#txt_Nombre', message: 'Ingrese la Descripción de la Menu!', action: 'keyup, blur', rule: 'required'},
...
<div id="div_VentanaPrincipal" style="display: none">
    <div>
        <span style="float: left">DATOS DEL MENÚ DEL SISTEMA</span>
    </div>
    <div style="overflow: hidden">
        <form id="frm_Menu" name="frm_Menu" method="post" >
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="inputlabel">Módulo : </td>
                    <td>
