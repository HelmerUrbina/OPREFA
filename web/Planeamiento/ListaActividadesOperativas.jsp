...
<script type="text/javascript">
    ...
    var result = {codigo: '${d.codigo}', prioridad: '${d.prioridad}', descripcion: '${d.descripcion}',
        categoriaPresupuestal: '${d.categoriaPresupuestal}', producto: '${d.producto}',
        actividad: '${d.actividad}', unidadMedida: '${d.unidadMedida}', estado: '${d.estado}'};
    lista.push(result);
    </c:forEach>
    $(document).ready(function () {
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            columns: [
                {text: 'PRIORIDAD', dataField: 'prioridad', width: '4%', align: 'center', cellsAlign: 'center', cellclassname: cellclass},
                ...
                {text: 'CAT. PPTAL', dataField: 'categoriaPresupuestal', filtertype: 'checkedlist', width: '20%', align: 'center', cellclassname: cellclass},
                {text: 'UNI MED', dataField: 'unidadMedida', filtertype: 'checkedlist', width: '7%', align: 'center', cellsAlign: 'center', cellclassname: cellclass},
        ...
        $("#div_ContextMenu").on('itemclick', function (event) {
            ...
            if (codigo === null || codigo === '') {
                ...
                } else if ($.trim($(opcion).text()) === "Ver Detalle") {
        ...
        $("#div_GrillaRegistro").jqxGrid({
            ...
            rendertoolbar: function (toolbar) {
                ...
                addButtonDet.click(function (event) {
                    ...
                    $("#cbo_AreaLaboral").jqxDropDownList({disabled: false});
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (dato.length === 74) {
                                    ...
                                    $("#cbo_AreaLaboral").jqxDropDownList('selectItem', dato[1]);
                                    ...
                                    $("#cbo_AreaLaboral").jqxDropDownList({disabled: true});
                                }
                            }
                        });
                        $('#div_VentanaDetalle').jqxWindow({isModal: true, modalOpacity: 0.9});
            ...
            columns: [
                ...
                {text: 'RESPONABLE', datafield: 'responsable', width: "20%", align: 'center', cellsAlign: 'center'},
            ...
            function _createElements() {
                ...
                $('#div_VentanaPrincipal').jqxWindow({
                    ...
                    initContent: function () {
                        ...
                        $("#cbo_CategoriaPresupuestal").jqxDropDownList({width: 450, height: 20, dropDownWidth: 500, promptText: "Seleccione"});
                        $("#cbo_Producto").jqxDropDownList({width: 450, height: 20, dropDownWidth: 500, promptText: "Seleccione"});
                        $("#cbo_Actividad").jqxDropDownList({width: 450, height: 20, dropDownWidth: 500, promptText: "Seleccione"});
                        $("#cbo_UnidadMedida").jqxDropDownList({width: 250, height: 20, dropDownWidth: 350, promptText: "Seleccione"});
                ...
                $('#div_VentanaDetalle').jqxWindow({
                    ...
                    initContent: function () {
                        $("#cbo_TareaOperativa").jqxDropDownList({width: 450, height: 20, dropDownWidth: 500, promptText: "Seleccione"});
                        $("#cbo_AreaLaboral").jqxDropDownList({width: 300, height: 20, dropDownWidth: 500, promptText: "Seleccione"});
        ...
        function fn_EditarRegistro() {
            $.ajax({
                ...
                success: function (data) {
                    var dato = data.split("+++");
                    if (dato.length === 7) {
                        $("#div_Prioridad").val(dato[0]);
                        $("#txt_Descripcion").val(dato[1]);
                        $("#cbo_CategoriaPresupuestal").val(dato[2]);
                        $("#cbo_Producto").val(dato[3]);
                        $("#cbo_Actividad").val(dato[4]);
    ...
    //FUNCION PARA ACTUALIZAR EL DETALLE
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (i = 1; i < fila.length; i++) {
                    ...
                    var row = {detalle: datos[0], tareaOperativa: datos[1], responsable: datos[2],
    ...
    //FUNCION PARA GRABAR EL DETALLE
    function fn_GrabarDatosDetalle() {
        ...
        $.ajax({
            ...
            data: {mode: modeDetalle, periodo: periodo, objetivo: objetivo, accion: accion, actividades: codigo,
                tareaOperativa: tareaOperativa, areaLaboral: areaLaboral,
...
<div id="div_VentanaPrincipal" style="display: none">
    <div>
        <span style="float: left">POI - ACTIVIDAD OPERATIVA INSTITUCIONAL</span>
    </div>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <select id="cbo_Producto" name="cbo_Producto">
                            <c:forEach var="f" items="${objProductos}">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <select id="cbo_Actividad" name="cbo_Actividad">
                            <c:forEach var="g" items="${objActividades}">
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            <select id="cbo_TareaOperativa" name="cbo_TareaOperativa">
                                <c:forEach var="e" items="${objTareasOperativas}">
                                    <option value="${e.codigo}">${e.descripcion}</option>
                                </c:forEach>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            <select id="cbo_AreaLaboral" name="cbo_AreaLaboral">
                                <c:forEach var="e" items="${objAreaLaboral}">
                                    <option value="${e.codigo}">${e.descripcion}</option>
                                </c:forEach>
                            </select>
                        </td>
                    </tr>
                    <tr class="TextoCabeceraTabla" style="text-align: center">
                        <td rowspan="2">Mes</td>
                        <td colspan="2"><div id="div_periodoA"></div></td>
                        <td colspan="2"><div id="div_periodoB"></div></td>
                        <td colspan="2"><div id="div_periodoC"></div></td>
                    </tr>
                    <tr class="TextoCabeceraTabla" style="text-align: center">
                        <td>Monto S/</td>
                        <td>Meta Fisica</td>
...
<div id='div_ContextMenu' style='display: none;'>
    <ul>
        ...
        <li style="color: blue; font-weight: bold;">Ver Detalle</li>
    </ul>
</div>