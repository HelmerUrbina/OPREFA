...
<script type="text/javascript">
    ...
    var msg = "";
    var lista = new Array();
    <c:forEach var="c" items="${objObjetivosEstrategicos}">
    var result = {codigo: '${c.codigo}', descripcion: '${c.descripcion}', abreviatura: '${c.abreviatura}', prioridad: '${c.prioridad}',
        fechaInicio: '${c.fechaInicio}', fechaFinal: '${c.fechaFinal}', unidadMedida: '${c.unidadMedida}', estado: '${c.estado}'};
    lista.push(result);
    </c:forEach>
...
<div id="div_VentanaPrincipal" style="display: none">
    <div>
        <span style="float: left">PEI - OBJETIVOS ESTRATÉGICOS INSTITUCIONALES</span>
    </div>
