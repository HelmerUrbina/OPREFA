<%-- 
    Document   : ReportesPlaneamiento
    Created on : 25/03/2020, 02:29:34 AM
    Author     : H-URBINA-M
--%>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        var source = [
            {id: "PLA0001", label: "1. Plan Operativo Institucional"},
            {id: "PLA0002", label: "2. Avance de Ejecución Presupuestal - PIA -PIM "}
        ];
        var theme = getTheme();
...
<div style="border: none;" id='div_Titulo'>
    <div class="jqx-hideborder">REPORTES PLANEAMIENTO</div>
    <div>
        <div id="div_Cabecera">
            <table class="navy">
                <tbody>
