<%-- 
    Document   : ListaInstituciones
    Created on : 30/03/2020, 11:07:03 PM
    Author     : H-URBINA-M
--%>
...
<script type="text/javascript">
    ...
    var msg = "";
    var lista = new Array();
    <c:forEach var="d" items="${objInstituciones}">
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            rendertoolbar: function (toolbar) {
                ...
                ButtonExportar.click(function (event) {
                    $("#div_GrillaPrincipal").jqxGrid('exportdata', 'xls', 'Listado de Instituciones');
                });
                ...
                $('#div_VentanaPrincipal').jqxWindow({
                    ...
                    initContent: function () {
                        ...
                        $('#btn_Guardar').on('click', function () {
                            $('#frm_Instituciones').jqxValidator('validate');
                        });
                        $('#frm_Instituciones').jqxValidator({
                            rules: [
...
<div id="div_VentanaPrincipal" style="display: none">
    ...
    <div style="overflow: hidden">
        <form id="frm_Instituciones" name="frm_Instituciones" method="post" >
