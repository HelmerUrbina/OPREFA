<%-- 
    Document   : ListaDocumentosDecretados
    Created on : 05/04/2020, 01:52:56 AM
    Author     : H-URBINA-M
--%>
...
<script type="text/javascript">
    ...
    var tipo = 'E';
    var lista = new Array();
    <c:forEach var="d" items="${objDocumetosDecretados}">
    var result = {numero: '${d.numero}', decreto: '${d.decreto}', numeroDocumento: '${d.numeroDocumento}', asunto: '${d.asunto}',
        prioridad: '${d.prioridad}', institucion: '${d.institucion}', fecha: '${d.fecha}', estado: '${d.estado}', firma: '${d.postFirma}',
        legajo: '${d.legajo}', folio: '${d.folio}', usuarioResponsable: '${d.usuarioResponsable}', comentario: '${d.mes}',
        archivo: '${d.archivo}'};
    lista.push(result);
    </c:forEach>
    $(document).ready(function () {
        ...
        var source = {
            ...
            root: "DocumentosDecretados",
            record: "DocumentosDecretados",
            id: 'numero'
        };
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            columns: [
                ...
                {text: 'INSTITUCIÓN', dataField: 'institucion', width: '9%', align: 'center', cellsAlign: 'center', cellclassname: cellclass},
                ...
                {text: 'FIRMA', dataField: 'firma', width: '14%', align: 'center', cellsAlign: 'left', cellclassname: cellclass},
