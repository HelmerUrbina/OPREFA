<%-- 
    Document   : ListaTipoDecretos
    Created on : 31/03/2020, 11:53:29 AM
    Author     : H-URBINA-M
--%>
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            rendertoolbar: function (toolbar) {
                ...
                ButtonExportar.click(function (event) {
                    $("#div_GrillaPrincipal").jqxGrid('exportdata', 'xls', 'Listado de Tipo de Decretos');
                });
                ...
                $('#div_VentanaPrincipal').jqxWindow({
                    ...
                    initContent: function () {
                        ...
                        $('#btn_Guardar').on('click', function () {
                            $('#frm_TipoDecretos').jqxValidator('validate');
                        });
                        $('#frm_TipoDecretos').jqxValidator({
                            rules: [
...
<div id="div_VentanaPrincipal" style="display: none">
    <div>
        <span style="float: left">DATOS DEL TIPO DE DECRETO</span>
    </div>
    <div style="overflow: hidden">
        <form id="frm_TipoDecretos" name="frm_TipoDecretos" method="post" >
