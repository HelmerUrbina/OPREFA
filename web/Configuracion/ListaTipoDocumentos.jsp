<%-- 
    Document   : ListaTipoDocumentos
    Created on : 30/03/2020, 11:49:40 PM
    Author     : H-URBINA-M
--%>
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            rendertoolbar: function (toolbar) {
                ...
                ButtonExportar.click(function (event) {
                    $("#div_GrillaPrincipal").jqxGrid('exportdata', 'xls', 'Listado de Tipo de Documentos');
                });
                ...
                $('#div_VentanaPrincipal').jqxWindow({
                    ...
                    initContent: function () {
                        ...
                        $('#btn_Guardar').on('click', function () {
                            $('#frm_TipoDocumentos').jqxValidator('validate');
                        });
                        $('#frm_TipoDocumentos').jqxValidator({
                            rules: [
...
<div id="div_VentanaPrincipal" style="display: none">
    ...
    <div style="overflow: hidden">
        <form id="frm_TipoDocumentos" name="frm_TipoDocumentos" method="post" >
