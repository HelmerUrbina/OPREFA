<%-- 
    Document   : ListaClasificacionDocumentos
    Created on : 31/03/2020, 12:45:15 AM
    Author     : H-URBINA-M
--%>
...
<script type="text/javascript">
    ...
    var msg = "";
    var lista = new Array();
    <c:forEach var="d" items="${objClasificacionDocumentos}">
    ...
    $(document).ready(function () {
        ...
        var source = {
            ...
            root: "ClasificacionDocumentos",
            record: "ClasificacionDocumentos",
            id: 'codigo'
        };
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            rendertoolbar: function (toolbar) {
                ...
                ButtonExportar.click(function (event) {
                    $("#div_GrillaPrincipal").jqxGrid('exportdata', 'xls', 'Listado de Clasificacion de Documentos');
                });
                ...
                $('#div_VentanaPrincipal').jqxWindow({
                    ...
                    initContent: function () {
                        ...
                        $('#btn_Guardar').on('click', function () {
                            $('#frm_ClasificacionDocumentos').jqxValidator('validate');
                        });
                        $('#frm_ClasificacionDocumentos').jqxValidator({
                            rules: [
        ...
        function fn_GrabarDatos() {
            ...
            $.ajax({
                type: "POST",
                url: "../IduClasificacionDocumentos",
...
<div id="div_VentanaPrincipal" style="display: none">
    <div>
        <span style="float: left">DATOS DE LA CLASIFICACIÓN DE DOCUMENTO</span>
    </div>
    <div style="overflow: hidden">
        <form id="frm_ClasificacionDocumentos" name="frm_ClasificacionDocumentos" method="post" >
