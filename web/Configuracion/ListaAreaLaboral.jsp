<%-- 
    Document   : ListaAreaLaboral
    Created on : 22/03/2020, 12:52:12 PM
    Author     : H-URBINA-M
--%>
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            rendertoolbar: function (toolbar) {
                ...
                ButtonExportar.click(function (event) {
                    $("#div_GrillaPrincipal").jqxGrid('exportdata', 'xls', 'Listado de Area Laboral');
                });
                ...
                $('#div_VentanaPrincipal').jqxWindow({
                    ...
                    initContent: function () {
                        ...
                        $('#btn_Guardar').on('click', function () {
                            $('#frm_AreaLaboral').jqxValidator('validate');
                        });
                        $('#frm_AreaLaboral').jqxValidator({
                            rules: [
...
<div id="div_VentanaPrincipal" style="display: none">
    <div>
        <span style="float: left">DATOS DEL ÁREA LABORAL</span>
    </div>
    <div style="overflow: hidden">
        <form id="frm_AreaLaboral" name="frm_AreaLaboral" method="post" >
