...
public class ActividadesOperativasServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (objBnActividades.getMode().equals("G")) {
            ...
            request.setAttribute("objCategoriaPresupuestal", combos.getCategoriaPresupuestal());
            if (request.getAttribute("objTareasOperativas") != null) {
                request.removeAttribute("objTareasOperativas");
            }
            request.setAttribute("objTareasOperativas", combos.getTareaOperativa());
            if (request.getAttribute("objAreaLaboral") != null) {
                request.removeAttribute("objAreaLaboral");
            }
            request.setAttribute("objAreaLaboral", combos.getAreaLaboral());
            if (request.getAttribute("objProductos") != null) {
                request.removeAttribute("objProductos");
            }
            request.setAttribute("objProductos", combos.getProductos());
            if (request.getAttribute("objActividades") != null) {
                request.removeAttribute("objActividades");
            }
            request.setAttribute("objActividades", combos.getActividades());
        }
        ...
        if (objBnActividades.getMode().equals("U")) {
            ...
            result = objBnActividades.getPrioridad() + "+++"
                    + objBnActividades.getDescripcion() + "+++"
        ...
        if (objBnActividades.getMode().equals("B")) {
            result = "" + objDsActividades.getListaActividadesOperativasDetalle(objBnActividades, objUsuario.getUsuario());
        }
