...
public class TipoDecretosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (objBnTipoDecretos.getMode().equals("G")) {
        ...
        if (objBnTipoDecretos.getMode().equals("U")) {
            ...
            result = objBnTipoDecretos.getDescripcion() + "+++"
                    + objBnTipoDecretos.getAbreviatura();
        }
        //SE ENVIA DE ACUERDO AL MODO SELECCIONADO
        switch (request.getParameter("mode")) {
            case "tipoDecreto":
                dispatcher = request.getRequestDispatcher("Configuracion/TipoDecretos.jsp");
                break;
            case "G":
                dispatcher = request.getRequestDispatcher("Configuracion/ListaTipoDecretos.jsp");
                break;
            default:
                dispatcher = request.getRequestDispatcher("FinSession.jsp");
                break;
