 ...
 * @author H-URBINA-M
 */
@WebServlet(name = "IduAreaLaboralServlet", urlPatterns = {"/IduAreaLaboral"})
public class IduAreaLaboralServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        objBnAreaLaboral.setDescripcion(request.getParameter("descripcion"));
        objBnAreaLaboral.setAbreviatura(request.getParameter("abreviatura"));
        objDsAreaLaboral = new AreaLaboralDAOImpl(objConnection);
        // EJECUTAMOS EL PROCEDIMIENTO SEGUN EL MODO QUE SE ESTA TRABAJANDO
        int k = objDsAreaLaboral.iduAreaLaboral(objBnAreaLaboral, objUsuario.getUsuario());
        if (k != 0) {
        } else {
            ...
            objBnMsgerr.setTipo(objBnAreaLaboral.getMode());
