...
public class TipoDocumentosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (objBnTipoDocumentos.getMode().equals("G")) {
            if (request.getAttribute("objTipoDocumentos") != null) {
                request.removeAttribute("objTipoDocumentos");
            }
            request.setAttribute("objTipoDocumentos", objDsTipoDocumentos.getListaTipoDocumentos());
        }
        if (objBnTipoDocumentos.getMode().equals("U")) {
            objBnTipoDocumentos = objDsTipoDocumentos.getTipoDocumento(objBnTipoDocumentos);
        ...
        switch (request.getParameter("mode")) {
            case "tipoDocumento":
                dispatcher = request.getRequestDispatcher("Configuracion/TipoDocumentos.jsp");
                break;
            case "G":
                dispatcher = request.getRequestDispatcher("Configuracion/ListaTipoDocumentos.jsp");
                break;
            default:
                dispatcher = request.getRequestDispatcher("FinSession.jsp");
                break;
