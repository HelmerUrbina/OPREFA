...
public class IduTipoDocumentosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        objBnTipoDocumentos.setDescripcion(request.getParameter("descripcion"));
        objBnTipoDocumentos.setAbreviatura(request.getParameter("abreviatura"));
        objDsTipoDocumentos = new TipoDocumentosDAOImpl(objConnection);
        // EJECUTAMOS EL PROCEDIMIENTO SEGUN EL MODO QUE SE ESTA TRABAJANDO
        int k = objDsTipoDocumentos.iduTipoDocumento(objBnTipoDocumentos, objUsuario.getUsuario());
        if (k != 0) {
        } else {
            ...
            objBnMsgerr.setTipo(objBnTipoDocumentos.getMode());
