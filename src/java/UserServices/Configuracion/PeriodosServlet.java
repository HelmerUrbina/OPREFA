...
public class PeriodosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (objBnPeriodo.getMode().equals("G")) {
        ...
        if (objBnPeriodo.getMode().equals("U")) {
            objBnPeriodo = objDsPeriodo.getPeriodo(objBnPeriodo);
            result = objBnPeriodo.getDescripcion() + "+++"
                    + objBnPeriodo.getImporte();
        }
        ...
        switch (request.getParameter("mode")) {
            case "periodo":
                ...
                break;
            case "G":
                dispatcher = request.getRequestDispatcher("Configuracion/ListaPeriodos.jsp");
                break;
            default:
                dispatcher = request.getRequestDispatcher("FinSession.jsp");
                break;
