...
public class CombosAjaxServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer presupuesto = Utiles.checkNum(request.getParameter("presupuesto"));
        Integer resolucion = Utiles.checkNum(request.getParameter("resolucion"));
        ...
        switch (mode) {
            ...
            case "tipoProcesoContratacion":
                ...
                break;
            case "procesoEtapa":
                request.setAttribute("objCombosAjax", objDsCombos.getProcesoEtapa(Utiles.checkNum(codigo)));
                break;
