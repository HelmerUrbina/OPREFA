...
public class JavaMail {
    ...
    public JavaMail(String correo, String archivo) {
        ...
        BODY = String.join(
                ...
                "<br>Mediante el presente se deja constancia que su documento ha sido registrado en la Mesa de Partes Digital en la Oficina Previsional de las Fuerzas Armadas y registrado en el Sistema de Trámite Documentario como se detallan en la siguiente imágen: ",
                "<br><br> <img src=\"cid:myimg\" width=\"600\" height=\"90\" alt=\"myimg\" />",
                "<br><br>Fecha Registro : " + Utiles.fechaServidor(),
                "<p><strong>Sistema de Trámite Documentario</strong>",
