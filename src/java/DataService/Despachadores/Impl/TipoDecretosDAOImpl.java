...
public class TipoDecretosDAOImpl implements TipoDecretosDAO {
    ...
    public List getListaTipoDecretos() {
        ...
        sql = "SELECT NTIPO_DECRETO_CODIGO AS CODIGO, VTIPO_DECRETO_DESCRIPCION AS DESCRIPCION, "
                + "VTIPO_DECRETO_ABREVIATURA AS ABREVIATURA, "
                + "PK_UTIL.FUN_DESCRIPCION_ESTADO(CESTADO_CODIGO) AS ESTADO "
                + "FROM OPREFA_TIPO_DECRETOS "
                + "ORDER BY CODIGO";
        try {
    ...
    public BeanComun getTipoDecreto(BeanComun objBeanComun) {
        sql = "SELECT VTIPO_DECRETO_DESCRIPCION AS DESCRIPCION, "
                + "VTIPO_DECRETO_ABREVIATURA AS ABREVIATURA, CESTADO_CODIGO AS ESTADO "
    ...
    public int iduTipoDecreto(BeanComun objBeanComun, String usuario) {
        ...
        try (CallableStatement cs = objConnection.prepareCall(sql)) {
            ...
            System.out.println("Error al ejecutar iduTipoDecreto : " + e.getMessage());
